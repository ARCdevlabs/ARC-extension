            ...
            for tung_column in Ele:
                try:
                    ...
                    if option_dim_combo_3 and combo_ref_top_3.Size > 2:
                        dim_top_3 = doc.Create.NewDimension(current_view, line_ngang_2, combo_ref_top_3)
                    ...
                    if option_dim_combo_3 and combo_ref_right_3.Size > 2:
                        dim_right_3 = doc.Create.NewDimension(current_view, line_doc_2, combo_ref_right_3)
