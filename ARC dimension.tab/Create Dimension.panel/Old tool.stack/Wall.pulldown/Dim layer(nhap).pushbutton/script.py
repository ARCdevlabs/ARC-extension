        ...
        for wall in Ele:
            try:
                ...
                if is_plan_view:                
                    ...
                    for tung_cap_ref in list_combo_reference: 
                        with revit.Transaction('Tao dim tam thoi', swallow_errors=True):
                            ...
                            dim = doc.Create.NewDimension(current_view, line_combo_1, wall_reference)
                    ...
                    with revit.Transaction('tao lai dim', swallow_errors=True):  
                        dim = doc.Create.NewDimension(current_view, line_combo_1, new_wall_reference) 
                ...
                if is_section_elevation:
                    ...
                    tinh_toan_offset_tinh_tu_mat_dam_phuong_chieu_cao = (chieu_cao_tuong/2 + 450/304.8) / view_scale #chia trước cho scale vì def move_line_theo_vector_theo_ty_le_view nhân scale lên lại.
