...
if module.AutodeskData():
    ...
    all_room = module.get_all_elements_of_OST_in_current_view(doc, BuiltInCategory.OST_Rooms)

    for tung_room in all_room:
        room_name = module.get_parameter_by_name(tung_room, )
