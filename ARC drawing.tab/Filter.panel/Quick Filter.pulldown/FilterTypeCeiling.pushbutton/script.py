...
class MyForm(Form):
    def __init__(self):
        ...
        self.textBox_1.Text = "Ceiling_type name_e_"
    ...
    def on_print_button_click(self, sender, e):
        ...
        category.Add(ElementId(BuiltInCategory.OST_Ceilings))
