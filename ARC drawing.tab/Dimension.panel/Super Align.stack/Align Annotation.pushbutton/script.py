...
__doc__ = 'Công cụ căn chỉnh các annotation (Text Notes, Room Tags, Tags, Multi-Category Tags, Wall Tags, Structural Framing Tags, Structural Foundation Tags, Floor Tags, Door Tags, Window Tags, Generic Annotations, Dimensions, Lines, Generic Model Tags, Casework Tags, Detail Item Tags) theo đối tượng chuẩn.'
...
try:
    ...
    elif category in ["Tags", "Multi-Category Tags", "Wall Tags", "Structural Framing Tags", "Structural Foundation Tags", "Floor Tags", "Door Tags", "Window Tags", "Generic Model Tags", "Casework Tags", "Detail Item Tags"]:
        def tinh_toan_phuong_align(reference_point, target_point):
            try:
                if reference_point is None or target_point is None:
                    return XYZ(0, 0, 0)
