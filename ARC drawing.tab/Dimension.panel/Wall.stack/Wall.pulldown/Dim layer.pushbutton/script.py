    ...
    if Ele:
        ...
        for wall in Ele:
            try:                
                ...
                string_face_center_core = get_wall_reference_by_magic(unique_id,4) #Co ve -9999 va id 4 luon luon la tam tuong
                ...
                if is_section_elevation:
                    ...
                    if check_goc_cua_dam_so_voi_view_direction(wall,current_view): #phòng trường hợp dim dầm nhìn thấy theo phương song song với mặt cắt mà cũng dim vào. dễ gây ra lỗi
                        ...
                        tinh_toan_offset_tinh_tu_mat_dam_phuong_chieu_cao = (chieu_cao_tuong/2/304.8)#chia trước cho scale vì def move_line_theo_vector_theo_ty_le_view nhân scale lên lại.
