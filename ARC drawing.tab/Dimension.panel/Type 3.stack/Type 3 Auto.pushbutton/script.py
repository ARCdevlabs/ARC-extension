...
try:
    ...
    trans_group = TransactionGroup(doc, 'Move text dim type 3 (auto)')
    trans_group.Start()
        ...
        try:
            ...
            if number_of_segments != 0:
                ...
                if len(sorted_phai) == 2:
                    ...
                    movetextdim.move_dim_segment_ben_trong_len_tren (segment_phai_1,kich_co_chu_phai_1, kich_co_chu_phai_0, vi_tri_text_ben_ngoai_phai, vector_da_chuan_hoa , xoay_vector_90_do, text_size_in_view, quy_doi_theo_ty_le, huong_phai = True)
                ...
                if len(sorted_trai) == 2:
                    ...
                    movetextdim.move_dim_segment_ben_trong_len_tren (segment_trai_1,kich_co_chu_trai_1, kich_co_chu_trai_0, vi_tri_text_ben_ngoai_trai, vector_da_chuan_hoa , xoay_vector_90_do, text_size_in_view, quy_doi_theo_ty_le, huong_phai = False)
