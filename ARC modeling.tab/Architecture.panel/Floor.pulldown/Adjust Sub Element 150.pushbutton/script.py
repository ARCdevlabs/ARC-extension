                        ...
                        for i in slab_shape_editor:
                            ...
                            if position.X == point_2.X:
                                if position.Y == point_2.Y:
                                        ...
                                        height_offset = (module.get_builtin_parameter_by_name(get_floor, DB.BuiltInParameter.FLOOR_HEIGHTABOVELEVEL_PARAM).AsDouble())
                                        ...
                                        Z_chenh_lech = Z_point_2 + (150/304.8) - floor_host_elevation
                                        # print Z_point_2, Z_chenh_lech
